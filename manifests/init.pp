...
class maxscale (
  String  $package_name             = lookup('maxscale::package_name'),
  String  $repository_base_url      = lookup('maxscale::repository_base_url'),
  String  $package_version          = lookup('maxscale::version'),
  Boolean $setup_mariadb_repository = true,
  Boolean $service_enable           = true,
  Integer $threads                  = lookup('maxscale::threads'),
  Integer $auth_connect_timeout     = lookup('maxscale::auth_connect_timeout'),
  Integer $auth_read_timeout        = lookup('maxscale::auth_read_timeout'),
  Integer $auth_write_timeout       = lookup('maxscale::auth_write_timeout'),
  Integer $ms_timestamp             = lookup('maxscale::ms_timestamp'),
  Boolean $syslog                   = lookup('maxscale::syslog'),
  Boolean $maxlog                   = lookup('maxscale::maxlog'),
  Boolean $log_to_shm               = lookup('maxscale::log_to_shm'),
  Boolean $log_warning              = lookup('maxscale::log_warning'),
  Boolean $log_notice               = lookup('maxscale::log_notice'),
  Boolean $log_info                 = lookup('maxscale::log_info'),
  Boolean $log_debug                = lookup('maxscale::log_debug'),
  Boolean $log_augmentation         = lookup('maxscale::log_augmentation'),
  String  $logdir                   = lookup('maxscale::logdir'),
  String  $datadir                  = lookup('maxscale::datadir'),
  String  $cachedir                 = lookup('maxscale::cachedir'),
  String  $piddir                   = lookup('maxscale::piddir'),
  String  $configdir                = lookup('maxscale::configdir'),
) {
